 ...
 */
export declare class CertificationResponse {
    readonly status: string;
     ...
     */
    static create(status: string): CertificationResponse;
    /**
     ...
     */
    static fromJSON(data: unknown): CertificationResponse;
    /**
     ...
     */
    static isJSON(data: unknown): data is ICertificationResponseJson;
    /**
     * Convert the response to a JSON object.
     *
     * @returns {ICertificationResponseJson} JSON representation of the response
     */
    toJSON(): ICertificationResponseJson;
}
