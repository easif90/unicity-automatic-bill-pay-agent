...
export interface IMintJustificationVerifier {
     ...
     */
    verify(transaction: CertifiedMintTransaction, mintJustificationVerifierService: MintJustificationVerifierService): Promise<VerificationResult<VerificationStatus>>;
}
