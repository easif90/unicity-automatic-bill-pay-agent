...
export class MintJustificationVerifierService {
    ...
    async verify(transaction) {
        ...
        if (!verifier) {
            return new VerificationResult('MintJustificationVerification', VerificationStatus.FAIL, `Unsupported mint justification tag: ${tag}.`);
        }
...
//# sourceMappingURL=MintJustificationVerifierService.js.map