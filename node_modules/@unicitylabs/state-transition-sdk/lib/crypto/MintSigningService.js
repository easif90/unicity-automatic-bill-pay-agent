...
export class MintSigningService {
    static MINTER_SECRET = HexConverter.decode('495f414d5f554e4956455253414c5f4d494e5445525f464f525f');
    /**
    ...
    static create(tokenId) {
        return new DataHasher(HashAlgorithm.SHA256)
            .update(CborSerializer.encodeArray(CborSerializer.encodeByteString(MintSigningService.MINTER_SECRET), tokenId.toCBOR()))
            .digest()
            .then((hash) => new SigningService(hash.data));
    }
}
//# sourceMappingURL=MintSigningService.js.map