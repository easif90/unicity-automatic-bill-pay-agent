 ...
 * transmitted as CBOR.
 */
export class EncodedPredicate {
    engine;
    _code;
    _params;
    static CBOR_TAG = 39032n;
    constructor(engine, _code, _params) {
        this.engine = engine;
        this._code = _code;
    ...
    static equals(a, b) {
        ...
        return (areUint8ArraysEqual(a.encodeCode(), b.encodeCode()) &&
    ...
    static fromCBOR(bytes) {
        ...
        return new EncodedPredicate(Number(engine), CborDeserializer.decodeByteString(data[1]), CborDeserializer.decodeByteString(data[2]));
    }
    /**
     ...
     */
    toCBOR() {
        return CborSerializer.encodeTag(EncodedPredicate.CBOR_TAG, CborSerializer.encodeArray(CborSerializer.encodeUnsignedInteger(this.engine), CborSerializer.encodeByteString(this._code), CborSerializer.encodeByteString(this._params)));
    }
    /**
...
//# sourceMappingURL=EncodedPredicate.js.map