...
export interface IPredicateVerifier {
     ...
     */
    verify(encodedPredicate: IPredicate, sourceStateHash: DataHash, transactionHash: DataHash, unlockScript: Uint8Array): Promise<VerificationResult<VerificationStatus>>;
}
