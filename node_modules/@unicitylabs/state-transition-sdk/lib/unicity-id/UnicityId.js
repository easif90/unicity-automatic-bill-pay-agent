...
export class UnicityId {
    ...
    static fromCBOR(bytes) {
        ...
        return new UnicityId(CborDeserializer.decodeTextString(data[0]), CborDeserializer.decodeNullable(data[1], CborDeserializer.decodeTextString));
    }
    /**
     ...
     */
    toCBOR() {
        return CborSerializer.encodeArray(CborSerializer.encodeTextString(this.name), CborSerializer.encodeNullable(this.domain, CborSerializer.encodeTextString));
    }
    /**
    ...
    async toTokenId() {
        const hash = await new DataHasher(HashAlgorithm.SHA256)
            .update(CborSerializer.encodeArray(CborSerializer.encodeTextString('NAMETAG_'), CborSerializer.encodeNullable(this.domain, CborSerializer.encodeTextString), CborSerializer.encodeTextString(this.name)))
            .digest();
        return new TokenId(hash.data);
    }
}
//# sourceMappingURL=UnicityId.js.map