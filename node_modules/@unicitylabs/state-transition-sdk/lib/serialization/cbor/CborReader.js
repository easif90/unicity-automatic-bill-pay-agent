...
export class CborReader {
    data;
    static ADDITIONAL_INFORMATION_MASK = 0b00011111;
    static MAJOR_TYPE_MASK = 0b11100000;
    position = 0;
    constructor(data) {
        this.data = data;
    }
    ...
    assertExhausted() {
        if (this.position !== this.data.length) {
            throw new CborError(`Expected end of data: ${this.data.length - this.position} byte(s) remaining at position ${this.position}.`);
        }
    }
    /**
     ...
     */
    readLength(majorType) {
        const initialByte = this.readByte();
        const parsedMajorType = initialByte & CborReader.MAJOR_TYPE_MASK;
