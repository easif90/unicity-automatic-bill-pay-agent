...
declare const PERMISSION_SCOPES: {
    ...
    readonly MINT_REQUEST: "mint:request";
...
declare class ConnectHost {
    ...
    setIntentAutoApprove(action: string, handler: (action: string, params: Record<string, unknown>, session: ConnectSession) => Promise<{
        result?: unknown;
        error?: {
            code: number;
            message: string;
