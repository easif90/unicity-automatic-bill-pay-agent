 ...
 */
export function deriveConversationKey(myPrivateKey, theirPublicKey) {
 ...
 */
export function deriveConversationKeyHex(myPrivateKeyHex, theirPublicKeyHex) {
 ...
 */
export function encrypt(message, myPrivateKey, theirPublicKey) {
 ...
 * @returns Base64-encoded encrypted payload
 */
export function encryptWithKey(message, conversationKey) {
 ...
 */
export function decrypt(encryptedContent, myPrivateKey, theirPublicKey) {
    const conversationKey = deriveConversationKey(myPrivateKey, theirPublicKey);
 ...
 * @returns Decrypted plaintext message
 */
export function decryptWithKey(encryptedContent, conversationKey) {
 ...
 */
export function encryptHex(message, myPrivateKeyHex, theirPublicKeyHex) {
    const myPrivateKey = hexToBytes(myPrivateKeyHex);
    const theirPublicKey = hexToBytes(theirPublicKeyHex);
 ...
 */
export function decryptHex(encryptedContent, myPrivateKeyHex, theirPublicKeyHex) {
    const myPrivateKey = hexToBytes(myPrivateKeyHex);
    const theirPublicKey = hexToBytes(theirPublicKeyHex);
