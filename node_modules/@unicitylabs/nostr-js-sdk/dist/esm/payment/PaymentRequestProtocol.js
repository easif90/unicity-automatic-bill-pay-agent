 ...
 */
export async function createPaymentRequestEvent(keyManager, targetPubkeyHex, request) {
 ...
 */
export async function parsePaymentRequest(event, keyManager) {
    // Verify event kind
 ...
 */
export function isPaymentRequest(event) {
    return (event.kind === EventKinds.PAYMENT_REQUEST &&
 ...
 */
export function getRecipientNametag(event) {
 ...
 */
export function parseAmount(amountStr, decimals = 8) {
 ...
 */
export function getRemainingTimeMs(request) {
 ...
 * @returns Signed event
 */
export async function createPaymentRequestResponseEvent(keyManager, targetPubkeyHex, response) {
 ...
 */
export async function parsePaymentRequestResponse(event, keyManager) {
    // Verify event kind
 ...
 */
export function isPaymentRequestResponse(event) {
    return (event.kind === EventKinds.PAYMENT_REQUEST_RESPONSE &&
 ...
 */
export function getOriginalEventId(event) {
    return event.getTagValue('e');
}
//# sourceMappingURL=PaymentRequestProtocol.js.map