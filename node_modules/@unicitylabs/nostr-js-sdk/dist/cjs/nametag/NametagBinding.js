...
exports.UNICITY_NAMETAG_NAMESPACE = void 0;
 ...
 */
exports.UNICITY_NAMETAG_NAMESPACE = 'unicity:nametag';
/**
...
async function createBindingEvent(keyManager, nametagId, unicityAddress, defaultCountry = DEFAULT_COUNTRY, identity) {
    ...
    const tags = [
        ...
        ['L', exports.UNICITY_NAMETAG_NAMESPACE],
...
function hasNametagOwnershipMarker(event) {
    return event.getTagValues('L').includes(exports.UNICITY_NAMETAG_NAMESPACE);
}
/**
